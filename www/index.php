      ...
      <div id="view-home" class="view view-main view-init tab tab-active">
        <div class="page" data-name="home">
          ...
          <div class="navbar navbar-large">
            ...
            <div class="navbar-inner">
              <div class="left">
                <a href="https://twitter.com/XBLOBLIVION" class="link icon-only external">
              ...
              <div class="title sliding">SignTunes</div>
              <div class="right">
              ...
              <div class="title-large">
                <div class="title-large-text">SignTunes</div>
              </div>
            </div>
          </div>
  ...
  <div class="card-content">
    <div style="height:300px;background:linear-gradient(to bottom right, #7F00FF, #E100FF);color:white;" style="height: 300px">
      <div class="card-header text-color-black display-block">
        <h1 style="color:white;font-size:30px;margin:0px;">SignTunes</h1>
    ...
    <div class="card-content-padding">
      <p >SignTunes is a new 3rd party iOS appstore that is in beta and will be one of the best.</p>
    </div>
  </div>
</div>
